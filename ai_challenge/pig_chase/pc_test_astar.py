...
from pc_utils import ACTION_SIZE, action_to_one_hot, extend_input, plot_line, leaderboard_save
    ...
    if can_test:
      ...
      for _ in range(args.evaluation_episodes):
        while True:
          ...
          action, meta_policy, (hx, cx) = model.act(symbols, Variable(input, volatile=True), reward, done, (hx.detach(), cx.detach()), is_training=False)
          cls = meta_policy.data[0, 0] < 0.5 and 0 or 1
